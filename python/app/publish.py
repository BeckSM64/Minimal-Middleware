...
for i in range(100):
    ...
    mmw.publish("Test Topic", "hello from python!", mmw.MmwReliability.MMW_BEST_EFFORT)
    mmw.publish("Test Topic 2", "hello from python 2!", mmw.MmwReliability.MMW_BEST_EFFORT)
mmw.cleanup()
